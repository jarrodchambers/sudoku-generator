...
# 2014: Generate a bunch of puzzles and see what the distribution is of non-blanks

while ($PUZZLE_NUMBER < 11) {
...
sub printMatrix
{
   ...
   # 2014: output the iteration number and number of non-blanks
   
   $datestamp = $PUZZLE_NUMBER . "_$nonblanks";
